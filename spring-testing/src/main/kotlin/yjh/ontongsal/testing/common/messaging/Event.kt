...
class Event<T : EventPayload>(
    ...
    fun toJson(): String = EventPayloadSerializer.serialize(this)
    ...
    companion object {
        ...
        fun fromJson(json: String): Event<EventPayload> {
            val raw = EventPayloadSerializer.deserialize(json, EventRaw::class.java)
            val type = EventType.from(raw.type)
            val payload = EventPayloadSerializer.deserialize(raw.payload, type.payloadClass)
